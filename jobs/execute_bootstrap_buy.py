"""
execute_bootstrap_buy.py  -  ONE-TIME use only.
...
Usage:
    python jobs/execute_bootstrap_buy.py --dry-run   # preview orders
    python jobs/execute_bootstrap_buy.py             # submit to Alpaca paper account
"""
