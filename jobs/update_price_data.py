...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Incrementally update GLD daily OHLCV data before live signal generation."
    )
    parser.add_argument("--data-csv", type=str, default=str(DEFAULT_DATA_CSV), help="GLD daily CSV path.")
